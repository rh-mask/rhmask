...
| Claim | Proof |
|---|---|
| Keys never leave your device | Open-source derivation, no network call in the code path |
| No account, no KYC | There is no sign-up. Nothing to give. |
| Non-custodial | Deposits go wallet → venue / contract. No server key controls funds. |
...
| planned, in progress, live | soon, coming, imminent |
